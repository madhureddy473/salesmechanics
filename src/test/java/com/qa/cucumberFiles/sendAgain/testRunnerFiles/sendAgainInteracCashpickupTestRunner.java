...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendAgain/featureFiles/sendAgainInteracCashpickup.feature",
...
public class sendAgainInteracCashpickupTestRunner extends AbstractTestNGCucumberTests {
}
