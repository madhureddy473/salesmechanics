Feature: sendMoneysofortAFghanisthan

    Scenario Outline: sendMoneysofortAFghanisthan
        ...
        And User logs in with credentiall "<userName>", "<password>", opens fee estimator page, selects "<receiverCountry>", "<receiverState>", and sends specified amount "<sendMoney>"
