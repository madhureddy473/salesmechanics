Feature: sendMoneyCashPupUStoHaiti

    Scenario Outline: sendMoneyCashPupUStoHaiti
        ...
        And User logs in with credentials "<userName>", "<password>", opens fee estimator page, selects "<receiverCountry>", and sends specified amount "<sendMoney>"
        #And User logs in with credential "<userName>", "<password>", opens fee estimator page, selects "<receiverCountry>", "<receiverState>", and sends specified amount "<sendMoney>"
