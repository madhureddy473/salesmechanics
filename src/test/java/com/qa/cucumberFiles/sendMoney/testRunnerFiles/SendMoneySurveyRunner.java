...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneySurveyScenarios.feature",
...
public class SendMoneySurveyRunner extends AbstractTestNGCucumberTests {
}
