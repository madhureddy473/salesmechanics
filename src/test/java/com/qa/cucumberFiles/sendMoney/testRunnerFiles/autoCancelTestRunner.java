...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/autoCancel.feature",
...
public class autoCancelTestRunner extends AbstractTestNGCucumberTests {
}
