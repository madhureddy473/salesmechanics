...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyusingreferalLink.feature",
...
public class sendMoneyusingreferalLinkTestRunner extends AbstractTestNGCucumberTests {
}
