...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyMobileWalletScenarios.feature",
...
public class sendMoneyMobileWalletRunner extends AbstractTestNGCucumberTests {
}
