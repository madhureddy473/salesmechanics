...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyTransactionReceiptScenarios.feature",
...
public class SendMoneyTransactionReceiptRunner extends AbstractTestNGCucumberTests {
}
