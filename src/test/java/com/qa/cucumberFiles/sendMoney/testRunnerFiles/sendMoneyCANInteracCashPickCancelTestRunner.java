...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyCANInteracCashPickCancel.feature",
...
public class sendMoneyCANInteracCashPickCancelTestRunner extends AbstractTestNGCucumberTests {
