...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneySofortCaskpickupCancel.feature",
...
public class sendMoneySofortCaskpickupCancelTestRunner extends AbstractTestNGCucumberTests {
}
