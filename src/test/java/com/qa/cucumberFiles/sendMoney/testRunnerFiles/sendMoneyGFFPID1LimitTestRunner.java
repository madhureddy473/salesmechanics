...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyGFFPID1Limit.feature",
...
public class sendMoneyGFFPID1LimitTestRunner extends AbstractTestNGCucumberTests {
}
