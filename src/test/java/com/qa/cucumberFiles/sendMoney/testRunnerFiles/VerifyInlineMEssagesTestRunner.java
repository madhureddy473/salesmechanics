...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/VerifyInlineMEssages.feature",
...
public class VerifyInlineMEssagesTestRunner extends AbstractTestNGCucumberTests {
}
