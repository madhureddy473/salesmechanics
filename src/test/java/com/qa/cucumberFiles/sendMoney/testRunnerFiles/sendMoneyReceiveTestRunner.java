...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyReceive.feature",
...
public class sendMoneyReceiveTestRunner extends AbstractTestNGCucumberTests {
}
