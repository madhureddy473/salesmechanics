...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyCancelNewModal.feature",
...
public class sendMoneyCancelNewModalTestRunner extends AbstractTestNGCucumberTests {
}
