...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendTocardTodifferentCardTypes.feature",
...
public class SendTocardTodifferentCardTypesTestRunner extends AbstractTestNGCucumberTests {
}
