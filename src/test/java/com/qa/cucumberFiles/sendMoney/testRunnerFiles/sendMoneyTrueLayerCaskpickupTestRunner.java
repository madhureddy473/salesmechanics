...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyTrueLayerCaskpickup.feature",
...
public class sendMoneyTrueLayerCaskpickupTestRunner extends AbstractTestNGCucumberTests {
}
