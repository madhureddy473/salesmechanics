...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/coockiePreferences.feature",
...
public class coockiePreferencesTestRunner extends AbstractTestNGCucumberTests {
}
