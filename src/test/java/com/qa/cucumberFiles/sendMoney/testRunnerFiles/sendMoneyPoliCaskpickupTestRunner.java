...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyPoliCaskpickup.feature",
...
public class sendMoneyPoliCaskpickupTestRunner extends AbstractTestNGCucumberTests {
}
