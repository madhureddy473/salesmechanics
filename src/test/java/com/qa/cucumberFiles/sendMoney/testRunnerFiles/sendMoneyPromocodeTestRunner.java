...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyPromocodeScenarios.feature",
...
public class sendMoneyPromocodeTestRunner extends AbstractTestNGCucumberTests {
}
