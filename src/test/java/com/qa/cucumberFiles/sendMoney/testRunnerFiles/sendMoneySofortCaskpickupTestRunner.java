...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneySofortCaskpickup.feature",
...
public class sendMoneySofortCaskpickupTestRunner extends AbstractTestNGCucumberTests {
}
