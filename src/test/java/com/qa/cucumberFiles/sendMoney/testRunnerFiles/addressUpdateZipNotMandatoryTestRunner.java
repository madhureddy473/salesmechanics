...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/addressUpdateZipNotMandatory.feature",
...
public class addressUpdateZipNotMandatoryTestRunner extends AbstractTestNGCucumberTests {
}
