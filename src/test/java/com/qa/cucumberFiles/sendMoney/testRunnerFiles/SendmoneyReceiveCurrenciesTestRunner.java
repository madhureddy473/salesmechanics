...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendmoneyReceiveCurrencies.feature",
...
public class SendmoneyReceiveCurrenciesTestRunner extends AbstractTestNGCucumberTests {
}
