...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyPayWithCashScenarios.feature",
...
public class SendMoneyPayWithCashRunner extends AbstractTestNGCucumberTests {
}
