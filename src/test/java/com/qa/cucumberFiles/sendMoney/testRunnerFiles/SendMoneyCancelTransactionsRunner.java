...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyCancelTransactionsScenarios.feature",
...
public class SendMoneyCancelTransactionsRunner extends AbstractTestNGCucumberTests {
}
