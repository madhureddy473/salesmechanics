...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/LocationTescoRKiosk.feature",
...
public class LocationTescoRKioskTestRunner extends AbstractTestNGCucumberTests {
}
