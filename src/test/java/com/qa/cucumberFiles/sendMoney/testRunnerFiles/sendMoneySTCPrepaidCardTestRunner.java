...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneySTCPrepaidCard.feature",
...
public class sendMoneySTCPrepaidCardTestRunner extends AbstractTestNGCucumberTests {
}
