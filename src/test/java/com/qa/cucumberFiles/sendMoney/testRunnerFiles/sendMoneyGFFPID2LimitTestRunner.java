...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/SendMoneyGFFPID2Limit.feature",
...
public class sendMoneyGFFPID2LimitTestRunner extends AbstractTestNGCucumberTests {
}
