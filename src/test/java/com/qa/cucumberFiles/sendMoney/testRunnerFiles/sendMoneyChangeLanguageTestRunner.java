...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyChangeLanguage.feature",
...
public class sendMoneyChangeLanguageTestRunner extends AbstractTestNGCucumberTests {
}