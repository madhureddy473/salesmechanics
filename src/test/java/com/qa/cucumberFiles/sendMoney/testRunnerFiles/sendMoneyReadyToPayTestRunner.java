...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
		...
		features = "src/test/java/com/qa/cucumberFiles/sendMoney/featureFiles/sendMoneyReadyToPay.feature",
...
public class sendMoneyReadyToPayTestRunner extends AbstractTestNGCucumberTests {
}
