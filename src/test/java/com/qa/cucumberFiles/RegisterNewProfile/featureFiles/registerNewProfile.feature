Feature: RegisterNewProfile

  Scenario Outline: registerNewProfile
    ...
    And Create a new Customer by using Sign Up process
    ...
    Then A User enters payment information "<creditCardNumber>", "<expiryMonth>", "<expiryYear>" and "<cvv>" and saves it
  #Then Test User enters the Additional details
    ...
    #Then A User views details on home page and cancels the transaction
