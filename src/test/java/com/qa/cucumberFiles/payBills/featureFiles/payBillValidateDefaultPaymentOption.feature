Feature: payBills
    ...
    Scenario Outline: payBillValidateDefaultPaymentOption
        ...
        And User search for Biller Name and Validate Default Payment Option "<feeEstimatorPaymentMethodOption>"
