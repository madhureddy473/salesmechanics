...
@CucumberOptions( //ensure this is CucumberOptions from testNG, NOT JUNIT!!!
        ...
        features = "src/test/java/com/qa/cucumberFiles/recurringPayments/featureFiles/recurringPaymentsSeries.feature",
...
public class RecurringPaymentsSeriesTestRunner extends AbstractTestNGCucumberTests {
}
